...
const CoursesPage = () => {
  ...
  // Extended courses data with the 4th course
  const allCourses = [
    ...coursesData,
    {
      id: 4,
      title: "Web Development with Mern",
      description: "Master full-stack development with Mern.",
    ...
    <div className="bg-gradient-to-r from-emerald-950 via-emerald-950 to-emerald-950 min-h-screen">
      ...
      <section className="bg-green-600 w-screen py-6 shadow-md rounded-2xl hover:border hover:border-green-white max-w-[1400px] mx-auto mt-8">
        <div className="max-w-full mx-auto px-6">
          ...
          <button className="flex items-center gap-2 mt-4 text-black font-medium">
      ...
      <div className="text-white -mb-8 mt-2 px-6 max-w-[1400px] mx-auto">
        <p>
          Showing <span className="font-semibold">{filteredCourses.length}</span> of {allCourses.length} courses
        </p>
      </div>
